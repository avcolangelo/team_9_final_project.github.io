...
When looking at the squirrel behavior maps, our motivation for visualisation was to deal with the location of certain behaviors and sounds of squirrels more straightforward. We also recoded logical vaviables of squirrel sounds, behaviors and interaction between human to be 0 or 1 in order to tidy data, then using leaflet to obtain the map of central park in NYC. It shows overall each behavior and sound are nearly evenly distributed among central park, so observers might have a chance to watch any behaviors, sounds or interact with squirrels.
