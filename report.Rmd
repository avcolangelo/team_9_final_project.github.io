...
When looking at the squirrel behavior maps, our motivation for visualisation was to deal with the location of certain behaviors and sounds of squirrels in a more straightforward fashion. We also recoded logical vaviables of squirrel sounds, behaviors and interactions between humans and squirrels to be 0 or 1 in order to tidy data. Then using leaflet we obtained the map of central park in NYC. The maps show overall that each behavior and sound are nearly evenly distributed among central park, so observers might have a chance to watch any behaviors, sounds or interact with squirrels.
